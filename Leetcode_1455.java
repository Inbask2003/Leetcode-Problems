/*
  1455. Check If a Word Occurs As a Prefix of Any Word in a Sentence --> (17/08/2024) --> (Easy)
...
is a prefix of more than one word, return the index of the first word (minimum index). If there is no such
word return -1.
