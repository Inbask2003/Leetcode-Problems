/*
  2903. Find Indices With Index and Value Difference I --> (24/08/2024) --> (Easy)
...
Output: [-1,-1]
Explanation: In this example, it can be shown that it is impossible to find two indices that satisfy both
conditions.
...
public class Leetcode_2903
{
    ...
    {
        int nums[] = {5,1,4,1};
        int indexDiffernce = 2;
        int valueDifference = 4;
        int out[] = findIndices(nums,indexDiffernce,valueDifference);
        for(int i : out)
        {
            System.out.print(i+" ");
        }
