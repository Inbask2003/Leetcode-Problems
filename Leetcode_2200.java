/*
  2200. Find All K-Distant Indices in an Array --> (19/08/2024) --> (Easy)
...
- For index 0, |0 - 2| > k and |0 - 5| > k, so there is no j where |0 - j| <= k and nums[j] == key. Thus,
0 is not a k-distant index.
